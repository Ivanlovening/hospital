                    ...
                    <div class="col-lg-12">
                        <div class="form-horizontal seperator" role="form" id="allControls">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control " id="phone" type="text" name="phone" value="<?php echo ($data['phone']); ?>" />
                                </div>
                            </div>
                            <!-- End .form-group  -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo U('Admin/Dealer/index');?>" type="button" class="btn btn-default" >不再修改</a>
                    <a href="<?php echo U('Admin/Dealer/edit', array('id'=>$data['id']));?>" type="button" class="btn btn-primary">继续修改</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<script type="text/javascript" src="/hospital/Public/Admin/js/main.js"></script><!-- Core js functions -->
    ...
    <script>
        var svaeDealer = "<?php echo U('Admin/Dealer/edit');?>";
        // 日历
        laydate({
